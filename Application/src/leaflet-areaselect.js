...
L.AreaSelect = L.Class.extend({
    ...
    setDimensionsMeters: function(dimensions){
      if(!dimensions) return;

      //First calculate meters per pixel.
        ...
        var pointY = [pointC.x, pointC.y + 100];
        ...
        //Now we know the meter per pixel ratio, make it update according to this.
        console.log(distanceX);
        console.log(distanceY);

        this._height = Math.floor(parseInt(dimensions.height) / distanceY)   || this._height;
        this._width =  Math.floor(parseInt(dimensions.width) / distanceX) || this._width;
        this._render();
        this.fire("change");
